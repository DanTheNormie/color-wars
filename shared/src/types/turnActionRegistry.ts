...
export const TURN_ACTION_REGISTRY = {
  ...
  UPGRADE_TERRITORY: {} as { playerId: string, territoryID: string, buildingType: DevelopmentType, amount: number },
  DOWNGRADE_TERRITORY: {} as { playerId: string, territoryID: string, amount: number },
